...
/* VARIABLES */
	...
	var props = {
		...
		globeRadius: 180, // Radius of the globe (used for many calculations)
		...
		colours: {
			// Cache the colours
			globeDots: "rgb(183, 171, 152)", // No need to use the Three constructor as this value is used for the HTML canvas drawing 'fillStyle' property
	...
	*/
	...
	function setupScene() {
		...
		var canvasResizeBehaviour = function () {
			...
			//SETS SIZE OF CIRCULATING RING
			container.style.width = containerWidth + "px";
			container.style.height = containerHeight+ "px";

			camera.object.aspect = containerWidth / containerHeight;
			camera.object.updateProjectionMatrix();


			//SETS SIZE OF GLOBER ITSELF
	...
	function animate() {
		...
		camera.controls.setAzimuthalAngle(Math.cos(Date.now() * 0.000001) * -360);
	...
	function addLineDots() {
		/*
		This function will create a number of dots (props.dotsAmount) which will then later be animated along the lines. The dots are set to not be visible as they are later
